...
│   ├── MIS 443_Q2_2025-2026 -Skeleton.sql        # Reference skeleton (different exam version)
│   └── Northwind.sql                              # Dataset (14 Northwind tables)
│
├── MIS443_2032300044_VUDONGDUONG/
│   ├── MIS 443_2032300044_VUDONGDUONG.sql         # Answer script (all 6 questions)
│   └── MIS 443_2032300044_VUDONGDUONG.pdf         # Report with query results
│
└── README.md
```
...
3. Open the Query Tool on the new database and run `Exam & Dataset/Northwind.sql` to load all 14 Northwind tables.
4. Open `MIS443_2032300044_VUDONGDUONG/MIS 443_2032300044_VUDONGDUONG.sql` and run the statements section by section to reproduce each question's result.
