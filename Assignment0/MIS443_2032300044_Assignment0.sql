...
-- ==========================================================
-- QUESTION: Please create SQL statements to fetch the first
-- 20 rows of each table in your sqlda database.
...
-- LIMIT only caps display at 20 rows, it does not reveal the
-- true row count when a table has 20+ rows. Use COUNT(*) instead.
...
-- A2: The 'products' table has fewer than 20 records (12 rows).
